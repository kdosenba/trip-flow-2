...
export default function Home() {
  ...
  if (isLoadingContext) {
    return (
      <main style={{ padding: '2rem', fontFamily: 'monospace', background: '#09090b', color: '#f4f4f5', minHeight: '100vh' }}>
        <h1 style={{ fontSize: '1.5rem', marginBottom: '1.5rem' }}>Client Context</h1>
        <div style={{ color: '#eab308' }}>Loading geolocation and client context...</div>
      </main>
    );
  }
  ...
  if (contextError) {
    return (
      <main style={{ padding: '2rem', fontFamily: 'monospace', background: '#09090b', color: '#f4f4f5', minHeight: '100vh' }}>
        <h1 style={{ fontSize: '1.5rem', marginBottom: '1.5rem' }}>Client Context Error</h1>
  ...
  return (
    <main style={{ padding: '2rem', fontFamily: 'monospace', background: '#09090b', color: '#f4f4f5', minHeight: '100vh' }}>
      <h1 style={{ fontSize: '1.5rem', marginBottom: '1.5rem' }}>Client Context Raw Data</h1>
      <pre style={{
        background: '#18181b',
        color: '#22c55e',
        padding: '1.5rem',
