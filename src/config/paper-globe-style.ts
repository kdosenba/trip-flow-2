export const initialPaperGlobeStyle: any = {
  "version": 8,
  "name": "Paper Craft Globe",
  "metadata": {
    "map:author": "Craft Developer",
    "map:description": "Strictly validated JSON with clean roads and complete labels with 3D elevation terrain."
  },
  "center": [-73.97, 40.71],
  "zoom": 14,
  "projection": {
  ...
  "layers": [
    ...
    },
    {
      ...
      "minzoom": 5,
      "filter": ["all", ["in", "class", "trunk", "primary"], ["==", "brunnel", "tunnel"]],
      "layout": {
        "line-cap": "butt",
        "line-join": "round"
      },
    ...
    },
    {
      ...
      "source-layer": "transportation",
      "minzoom": 9,
      "filter": ["all", ["==", "class", "secondary"], ["!=", "brunnel", "bridge"], ["!=", "brunnel", "tunnel"]],
      "layout": {
        "line-cap": "butt",
        "line-join": "round"
      },
    ...
    },
    {
      ...
      "source-layer": "transportation",
      "minzoom": 5,
      "filter": ["all", ["in", "class", "trunk", "primary"], ["!=", "brunnel", "bridge"], ["!=", "brunnel", "tunnel"]],
      "layout": {
        "line-cap": "butt",
        "line-join": "round"
      },
    ...
    },
    {
      ...
      "source-layer": "transportation",
      "minzoom": 13,
      "filter": ["all", ["in", "class", "minor", "tertiary", "residential"], ["!=", "brunnel", "bridge"], ["!=", "brunnel", "tunnel"]],
      "layout": {
        "line-cap": "round",
        "line-join": "round"
      },
    ...
    },
    {
      ...
      "source-layer": "transportation",
      "minzoom": 9,
      "filter": ["all", ["==", "class", "secondary"], ["==", "brunnel", "bridge"]],
      "layout": {
        "line-cap": "butt",
        "line-join": "round"
      },
    ...
    },
    {
      ...
      "source-layer": "transportation",
      "minzoom": 5,
      "filter": ["all", ["in", "class", "trunk", "primary"], ["==", "brunnel", "bridge"]],
      "layout": {
        "line-cap": "butt",
        "line-join": "round"
      },
    ...
    },
    {
      ...
      "source-layer": "transportation",
      "minzoom": 13,
      "filter": ["all", ["in", "class", "minor", "tertiary", "residential"], ["==", "brunnel", "bridge"]],
      "layout": {
        "line-cap": "round",
        "line-join": "round"
      },
